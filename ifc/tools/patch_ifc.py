...
_DPP_BASE_URL = os.environ.get("DPP_API_URL", "https://opendpp.buildingsmart.org").rstrip("/")
...
def main():
    ...
    files_base = os.environ.get("DPP_API_URL", "https://opendpp.buildingsmart.org").rstrip("/")
